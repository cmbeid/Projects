import type { Automation, Building, Content, ResourceId, Upgrade } from './types';
...
export function buildIndex(content: Content): ContentIndex {
  ...
  return { content, buildingById, upgradeById, automationById, producersOf, consumersOf, depotsOf };
}
